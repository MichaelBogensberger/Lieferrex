  ...
  public class DbInit implements CommandLineRunner {
      ...
      public void run(String... args) {
          ...
          if (mandantRepository.count() == 0) {
              ...
              Mandant mandant = new Mandant(null, "Asia Royal", "Österreich", "Zell am See", "5700", "Kitzsteinhornstraße", "33", "0654255264", 41.0, 50000, 15, 30, "aisaroyal@gmail.com", 10.0, 0, null, mandantBestellart, layouts.get(0), geoPosition);
              Mandant mandant2 = new Mandant(null, "Asiamix", "Österreich", "Gemeinde Imst", "6460", "Franz-Xaver-Renn-Straße", "4", "0650123123", 0, 50000,15, 30, "mandant@gmail.com", 7.5, 3.5, null, mandantBestellart, layouts.get(1), geoPosition2);
