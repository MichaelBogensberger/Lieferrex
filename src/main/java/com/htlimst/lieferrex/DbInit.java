...
public class DbInit implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                Mandant mandant = new Mandant(null, "Asia Royal", "Österreich", "Zell am See", "5700",
                                "Kitzsteinhornstraße",
                                "33", "0654255264", 41.0, 50000, 15, 30, "aisaroyal@gmail.com", 10.0, 0, null,
                                mandantBestellart,
                                layouts.get(0), geoPosition);
                Mandant mandant2 = new Mandant(null, "Asiamix", "Österreich", "Gemeinde Imst", "6460",
                                "Franz-Xaver-Renn-Straße", "4", "0650123123", 0, 50000, 15, 30, "mandant@gmail.com",
                                7.5, 3.5, null,
                ...
                Kunde kunde3 = new Kunde(null, "Max", "Mustermann", "kunde@gmail.com",
...
=======
        ...
        fragmentheaders.add(new FragmentHeader(null, "Cooler Titel Eins", "Cooler Text des ersten Fragments", null,
                fragments.get(0)));
        ...
        Gericht gericht = new Gericht(null, "Wiener Schnitzel", "Paniertes Kalbsschnitzel mit Kartoffelsalat", 10.50,
                0.0, 100, 1, mandant);
        this.gerichtRepository.save(gericht);
        Gericht gericht2 = new Gericht(null, "Döner", "Döner mit Mangosoße", 5.50, 1.0, 150, 2, mandant);
        this.gerichtRepository.save(gericht2);
        ...
        this.angestellterRepository.save(angestellter);
        String token1 = UUID.randomUUID().toString();
        Angestellter angestellter1 = new Angestellter(null, mandant2, "Liuming", "Xia", "angestellter@gmail.com",
                this.passwordEncoder.encode("123"), token1, angestellerRollen);
        this.angestellterRepository.save(angestellter1);
...
>>>>>>> fa4e516a20c338f310900ab17e091f2cf9acd461
}