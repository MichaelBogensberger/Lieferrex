...
//          Mandant mandant = new Mandant(null, "Asia Royal", "Österreich", "Zell am See", "5700", "Kitzsteinhornstraße", "33", "0654255264", 1234.5, 50000, 15, 30, "aisaroyal@gmail.com", 10.0, 0, null, mandantBestellart, layouts.get(0), geoPosition);
//          Mandant mandant2 = new Mandant(null, "Asiamix", "Österreich", "Gemeinde Imst", "6460", "Franz-Xaver-Renn-Straße", "4", "0650123123", 1234.5, 50000,15, 30, "mandant@gmail.com", 7.5, 3.5, null, mandantBestellart, layouts.get(1), geoPosition2);
//
//
...
//
//
//          Kunde kunde = new Kunde(null, "Michael", "Bogensberger", "michaelbogensberger@gmail.com", this.passwordEncoder.encode("123"), "Salzburg", "5026", "Ziegelstadelstraße", "6a", "06123456789", "Österreich", true);
//          this.kundeRepository.save(kunde);
//          Kunde kunde2 = new Kunde(null, "Julian", "Meilinger", "meilinger7@gmail.com", this.passwordEncoder.encode("123"), "Neukirchen am Großvenediger", "5741", "Geiernestgassl", "8", "065123456789", "Österreich", false);
//          this.kundeRepository.save(kunde2);
//          Kunde kunde3 = new Kunde(null, "Max", "Mustermann", "kunde@gmail.com", this.passwordEncoder.encode("123"), "Neukirchen am Großvenediger", "5741", "Geiernestgassl", "8", "065123456789", "Österreich", false);
...
//
//          Bestellung bestellung = new Bestellung(null, 10,  timestamp, 15.5, 2.5, bestellart, kunde, mandant, bestellstatus);
//          Bestellung bestellung2 = new Bestellung(null, 20, timestamp, 20.5, 0, bestellart1, kunde, mandant, bestellstatus);
...
//          GerichtBestellung gerichtBestellung2 = new GerichtBestellung(null, "Mit Knoblauchsoße", gericht3, bestellung2);
...
//          Angestellter angestellter = new Angestellter(null, mandant, "Niklas", "Heim", "angestellt@gmail.com", this.passwordEncoder.encode("123"), token , angestellerRollen);
//          this.angestellterRepository.save(angestellter);
//          String token1 = UUID.randomUUID().toString();
//          Angestellter angestellter1 = new Angestellter(null, mandant2, "Liuming", "Xia", "angestellter@gmail.com", this.passwordEncoder.encode("123"), token1, angestellerRollen);
...
//
//          Oeffnungszeit oeffnungszeit2 = new Oeffnungszeit(null, WochentagEnum.MONDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2);
//          this.oeffnungszeitRepository.save(oeffnungszeit);
//          this.oeffnungszeitRepository.save(new Oeffnungszeit(null, WochentagEnum.TUESDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2));
//          this.oeffnungszeitRepository.save(new Oeffnungszeit(null, WochentagEnum.WEDNESDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2));
//          this.oeffnungszeitRepository.save(new Oeffnungszeit(null, WochentagEnum.THURSDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2));
//          this.oeffnungszeitRepository.save(new Oeffnungszeit(null, WochentagEnum.FRIDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2));
//          this.oeffnungszeitRepository.save(new Oeffnungszeit(null, WochentagEnum.SATURDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2));
//          this.oeffnungszeitRepository.save(new Oeffnungszeit(null, WochentagEnum.SUNDAY, new Time(10, 0, 0), new Time(14, 0, 0), new Time(16, 0, 0), new Time(22, 0, 0), mandant2));
//
//
//          Umsatz umsatz = new Umsatz(null, 3, 2022, 22325.50, mandant);
//          this.umsatzRepository.save(umsatz);
//          Umsatz umsatz1 = new Umsatz(null, 4, 2022, 22220.80, mandant);
//          this.umsatzRepository.save(umsatz1);
